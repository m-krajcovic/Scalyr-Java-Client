...
* Download the [Java client library](https://oss.sonatype.org/content/groups/public/com/scalyr/scalyr-client/6.0.29/scalyr-client-6.0.29.jar) directly from Maven Central and add it to your project.
